...
var NewReportModalPage = /** @class */ (function () {
    function NewReportModalPage(viewCtrl, toastCtrl, formBuilder, imagePicker, firebaseService, loadingCtrl, params) {
    ...
    NewReportModalPage.prototype.ionViewWillLoad = function () {
        this.resetFields();
    ...
    NewReportModalPage.prototype.setFields = function (data) {
    ...
    NewReportModalPage.prototype.resetFields = function () {
        this.validations_form = this.formBuilder.group({
    ...
    NewReportModalPage.prototype.dismiss = function () {
        this.viewCtrl.dismiss();
    };
    NewReportModalPage.prototype.onSubmit = function (value) {
        var _this = this;
        var data = {
    ...
    return NewReportModalPage;
}());
export { NewReportModalPage };
//# sourceMappingURL=new-report-modal.js.map